...
$cases = [
    ...
    'builder attribute deferred' => ['AttributedRecord::first();', 'void', ['non-documented-method']],
    'custom builder native contract' => ['return (new CustomBuilder)->first();', 'string', []],
    'custom collection deferred' => ['CustomCollectionRecord::get();', 'void', ['non-documented-method']],
    'custom collection first deferred' => ['CustomCollectionRecord::first();', 'void', ['non-documented-method']],
    'collection property deferred' => ['CollectionPropertyRecord::get();', 'void', ['non-documented-method']],
    'collection attribute deferred' => ['CollectionAttributeRecord::get();', 'void', ['non-documented-method']],
    'inherited collection attribute deferred' => [
        'InheritedCollectionAttributeRecord::get();',
        'void',
    ...
    'sorting scope collision' => ['OrderingScopeRecord::orderBy("id");', 'void', ['non-documented-method']],
    'inherited scope collision' => ['InheritedOrderingScopeRecord::orderBy("id");', 'void', ['non-documented-method']],
    'count scope collision' => ['CountingScopeRecord::count();', 'void', ['non-documented-method']],
